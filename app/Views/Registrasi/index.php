...
<div class="page-phil registrasi">
    ...
    <section class="section-3">
        <div class="konten-phil konten-registrasi py-2">
            <div class="judul-2 text-center">Peserta Belum Terverifikasi</div>
            <div>
                <p style="text-align: justify">Setelah mengisi form registrasi, silahkan menghubungi ketua pelprap sesuai gerejanya masing-masing untuk proses verifikasi.
                </p>
            </div>
        ...
        <div class="konten-phil konten-registrasi py-2">
            <div class="judul-2 text-center">Peserta Terverifikasi</div>
            <div class="phil-tabel">
                <div class="search filter-select">
                    <label class="text-dark">Search </label>
                    <input class="form-control form-control-sm" type="search" style="background: rgba(255, 255, 255, 0.5);" id="keyword-peserta_verifikasi">
        ...
        <div class="konten-phil konten-registrasi py-2">
            <div class="judul-2 text-center">Summary</div>
            <div class="phil-tabel">
                <div class="search">
                    <label class="text-dark">Search </label>
                    <input class="form-control form-control-sm" type="search" style="background: rgba(255, 255, 255, 0.5);" id="keyword-peserta_summary">
