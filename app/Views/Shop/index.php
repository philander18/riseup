...
<div class="container-phil" x-data="{akses: '<?= $akses; ?>'}">
    ...
    <section class="section-3">
        <div class="konten-phil konten-shop py-2">
            ...
            <h4 class="mt-2 fw-bold text-center">Order Belum Lunas Batch 1</h4>
            <div class="px-2">
        ...
        <div class="konten-phil konten-shop py-2">
            <h4 class="mt-2 mb-4 fw-bold text-center">Order Lunas Batch 1</h4>
            <div class="phil-tabel">
                <div class="search">
                    <label class="text-dark">Search </label>
    ...
    <div class="judul-1">BATCH 0</div>
    <section class="section-2">
        <div class="konten-phil konten-shop py-2">
            <h4 class="mt-2 mb-4 fw-bold text-center">Order Batch 0</h4>
            <p style="text-align: justify;">Pre order pada batch 0 akan didistribusikan maksimal pada tanggal 23 Maret 2025 sesuai gereja/alamat masing-masing. Jika ada pertanyaan bisa menghubungi Reymond (085861294855).</p>
            <div class="phil-tabel">
                <div class="search">
                    <label class="text-dark">Search </label>
        ...
        <div class="konten-phil konten-shop py-2">
            <h4 class="mt-2 mb-4 fw-bold text-center">Rekap Pre-Order Batch 0</h4>
            <div class="phil-tabel">
                <div class="search">
                    <label class="text-dark">Search </label>
    ...
    <div class="judul-1">Produk Pre Order Batch 1</div>
...
<div class="page-phil page-shop" x-data="{akses: '<?= $akses; ?>'}">
